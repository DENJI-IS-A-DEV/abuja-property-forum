...
The admin dashboard now supports selecting property images directly from a phone or computer. Images are converted to data URLs and saved with demo listings in browser localStorage. For a production deployment, cloud/server image storage should be used instead.
